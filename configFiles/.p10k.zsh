# Generated by Powerlevel10k configuration wizard on 2022-11-06 at 17:19 PST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 19454.
# Wizard options: ascii, rainbow, 12h time, 1 line, sparse, fluent,
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='(Ͼ˳Ͽ) TEST'
